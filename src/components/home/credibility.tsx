...
export function Credibility() {
  return (
    <SectionRail id="perche-ora" label="Perché lo diciamo noi" tone="canvas" pad="xl">
      <h2 className="max-w-[20ch] text-balance text-3xl font-semibold leading-[1.1] tracking-tight text-ref-carbon sm:text-4xl md:text-5xl">
      ...
      <div
        ...
        className="mt-10 flex aspect-[16/9] max-w-[720px] items-center justify-center rounded-[16px] border border-ref-fog bg-ref-linen text-[13px] font-medium text-ref-ash"
      >
