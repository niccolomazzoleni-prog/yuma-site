...
// Griglia cinetica: si deforma verso il cursore e fa un'onda a ogni click.
// Rispetto al componente originale il canvas è ancorato al contenitore (non
// alla finestra), così può vivere come banda dentro la pagina; il loop gira
// solo quando la sezione è a schermo e resta fermo con "riduci animazioni".
...
const THEMES = {
  // Palette YUMA: fondo dell'hero + viola d'azione.
  yuma: {
    bg: "#0b1026",
    lineActive: { r: 124, g: 92, b: 250, a: 0.9 },
    nodeActive: { r: 167, g: 148, b: 255, a: 1.0 },
    glow: "124,92,250",
    ripple: "167,148,255",
  },
  default: {
...
export default function KineticGrid({
  ...
  children?: ReactNode;
  className?: string;
  globalColor?: keyof typeof THEMES;
}) {
  ...
  const draw = useCallback(
    (now: number) => {
      ...
      const theme = THEMES[globalColor] ?? THEMES.yuma;
  ...
  useEffect(() => {
    ...
    // Coordinate relative alla banda, non alla finestra.
    ...
    // Il loop gira solo mentre la banda è a schermo.
